        ...
        private void SelectScreen_Load(object sender, EventArgs e)
        {
            foreach (var s in Screen.AllScreens)
            {
                ...
                if (DetectedScreens == 1)
                {
                    ...
                    SBounds1 = s.Bounds;
                    labScreen1.Text = s.DeviceFriendlyName();
                }
                else if (DetectedScreens == 2)
                {
                    btnScreen2.ImageIndex = 1;
                    SBounds2 = s.Bounds;
                    labScreen2.Text = s.DeviceFriendlyName();
                }
                else if (DetectedScreens == 3)
                {
                    btnScreen3.ImageIndex = 1;
                    SBounds3 = s.Bounds;
                    labScreen3.Text = s.DeviceFriendlyName();
                }
                else if (DetectedScreens == 4)
                {
                    btnScreen4.ImageIndex = 1;
                    SBounds4 = s.Bounds;
                    labScreen4.Text = s.DeviceFriendlyName();
                }
                else if (DetectedScreens == 5)
                {
                    btnScreen5.ImageIndex = 1;
                    SBounds5 = s.Bounds;
                    labScreen5.Text = s.DeviceFriendlyName();
                }
                else if (DetectedScreens == 6)
                {
                    btnScreen6.ImageIndex = 1;
                    SBounds6 = s.Bounds;
                    labScreen6.Text = s.DeviceFriendlyName();
                }               
            }
